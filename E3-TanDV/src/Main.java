...
public class Main {
    public static void main(String[] args) {
        ...
        rooms.add(new Room("RQ001", roomType.Quad, 20.5f, 3));
        ...
        bookings.add(new Booking(1, rooms.getFirst(), customers.getFirst(), LocalDateTime.of(2023, 3, 15, 9, 30, 15), LocalDateTime.of(2023, 12, 16, 12, 30, 45)));
        ...
        bookings.add(new Booking(3, rooms.get(1), customers.get(1), LocalDateTime.of(2023, 3, 11, 10, 10, 5), LocalDateTime.of(2023, 12, 13, 11, 5, 10)));
