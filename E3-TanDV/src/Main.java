...
public class Main {
    public static void main(String[] args) {
        ...
        rooms.add(new Room("RQ001", roomType.Quad, 20.5f));
        ...
        bookings.add(new Booking(3, rooms.get(1), customers.get(1), LocalDateTime.of(2023, 3, 11, 10, 10, 5), LocalDateTime.of(2024, 12, 13, 11, 5, 10)));
